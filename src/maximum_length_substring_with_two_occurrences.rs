...
mod test {
    ...
    fn test_case_1() {
        ...
        assert_eq!(maximum_length_substring_v1(s), 4)
    }

    #[test]
    fn test_case_2() {
        let s = "aaaa".to_string();
        assert_eq!(maximum_length_substring_v1(s), 2)
    }

    #[test]
    fn test_case_3() {
        let s = "bcbbbcba".to_string();
        assert_eq!(maximum_length_substring_v2(s), 4)
    }

    #[test]
    fn test_case_4() {
        let s = "aaaa".to_string();
        assert_eq!(maximum_length_substring_v2(s), 2)
    }
}
